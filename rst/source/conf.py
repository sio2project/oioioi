...
project = "OIOIOI"
copyright = str(datetime.datetime.now().year) + ", The SIO2 Team"
...
latex_documents = [
    ("index", "oioioi.tex", "OIOIOI Documentation", "SIO2 Team", "manual"),
]
...
man_pages = [("index", "oioioi", "OIOIOI Documentation", ["SIO2 Team"], 1)]
