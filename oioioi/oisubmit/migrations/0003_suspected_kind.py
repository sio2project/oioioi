...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for susp_extradata in orm.OISubmitExtraData.objects.filter(
                    received_suspected=True):
            susp_extradata.submission.kind = 'SUSPECTED'
            susp_extradata.submission.save()

    def backwards(self, orm):
        for submission in orm['contests.Submission'].objects.filter(
                    kind='SUSPECTED'):
