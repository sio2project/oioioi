...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('oisubmit_oisubmitextradata', 'is_suspected', 'received_suspected')

    def backwards(self, orm):
        db.rename_column('oisubmit_oisubmitextradata', 'received_suspected', 'is_suspected')
    ...
    models = {
        ...
        'oisubmit.oisubmitextradata': {
            ...
            'received_suspected': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
