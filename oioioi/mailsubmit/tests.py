...
class TestMailSubmission(TestCase, MailSubmitFileMixin):
    ...
    def test_accepting_mailsubmissions(self):
        ...
        url = reverse("accept_mailsubmission_default", kwargs={"contest_id": contest.id})
        valid_post_data = {
    ...
    def test_mailsubmissions_list(self):
        c1 = Contest(
            id="contest1",
            name="Contest1",
            controller_name="oioioi.participants.tests.ParticipantsContestController",
        )
        c1.save()
        c2 = Contest(
            id="contest2",
