...
contest_patterns = [
    ...
    url(r'^questions/all/$', views.all_messages_view, name='contest_all_messages'),
    url(r'^questions/(?P<message_id>\d+)/$', views.message_view, name='message'),
    url(
    ...
    url(r'^questions/subscription/$', views.subscription, name='subscription'),
    url(
