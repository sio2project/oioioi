...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Message.date'
        db.alter_column('questions_message', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'MessageView.date'
        db.alter_column('questions_messageview', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
