...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReplyTemplate.usage_count'
        db.add_column(u'questions_replytemplate', 'usage_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReplyTemplate.usage_count'
        db.delete_column(u'questions_replytemplate', 'usage_count')
