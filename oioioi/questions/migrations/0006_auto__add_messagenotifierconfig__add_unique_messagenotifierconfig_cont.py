...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MessageNotifierConfig'
        db.create_table('questions_messagenotifierconfig', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contests.Contest'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('questions', ['MessageNotifierConfig'])

        # Adding unique constraint on 'MessageNotifierConfig', fields ['contest', 'user']
        db.create_unique('questions_messagenotifierconfig', ['contest_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'MessageNotifierConfig', fields ['contest', 'user']
        db.delete_unique('questions_messagenotifierconfig', ['contest_id', 'user_id'])

        # Deleting model 'MessageNotifierConfig'
        db.delete_table('questions_messagenotifierconfig')
    ...
    models = {
        ...
        'questions.messagenotifierconfig': {
