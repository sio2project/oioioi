...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.problem'
        db.delete_column('questions_message', 'problem_id')

        # Adding field 'Message.round'
        db.add_column('questions_message', 'round',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contests.Round'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Message.problem'
        db.add_column('questions_message', 'problem',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['problems.Problem'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Message.round'
        db.delete_column('questions_message', 'round_id')
