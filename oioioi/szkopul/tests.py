...
class TestMainPageView(TestCase):
    ...
    def test_order_in_last_submissions(self):
        ...
        submission_early = Submission(problem_instance=test_probleminstance,
                                      user=test_user, date=early_date).save()

        submission_mid = Submission(problem_instance=contestless_instance,
                                    problem_instance_id=contestless_instance.id,
                                    user=test_user, date=mid_date).save()
