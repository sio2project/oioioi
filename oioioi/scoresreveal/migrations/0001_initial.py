...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScoreReveal'
        db.create_table('scoresreveal_scorereveal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission', self.gf('django.db.models.fields.related.OneToOneField')(related_name='revealed', unique=True, to=orm['contests.Submission'])),
        ))
        db.send_create_signal('scoresreveal', ['ScoreReveal'])

        # Adding model 'ScoreRevealConfig'
        db.create_table('scoresreveal_scorerevealconfig', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('problem', self.gf('django.db.models.fields.related.OneToOneField')(related_name='scores_reveal_config', unique=True, to=orm['problems.Problem'])),
            ('reveal_limit', self.gf('django.db.models.fields.IntegerField')()),
            ('disable_time', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('scoresreveal', ['ScoreRevealConfig'])


    def backwards(self, orm):
        # Deleting model 'ScoreReveal'
        db.delete_table('scoresreveal_scorereveal')

        # Deleting model 'ScoreRevealConfig'
        db.delete_table('scoresreveal_scorerevealconfig')
    ...
    models = {
        ...
        'scoresreveal.scorereveal': {
            'Meta': {'object_name': 'ScoreReveal'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'submission': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'revealed'", 'unique': 'True', 'to': "orm['contests.Submission']"})
        },
        'scoresreveal.scorerevealconfig': {
            'Meta': {'object_name': 'ScoreRevealConfig'},
            'disable_time': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'problem': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'scores_reveal_config'", 'unique': 'True', 'to': "orm['problems.Problem']"}),
            'reveal_limit': ('django.db.models.fields.IntegerField', [], {})
        }
    }

    complete_apps = ['scoresreveal']