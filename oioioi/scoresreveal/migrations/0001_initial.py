    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission', models.OneToOneField(related_name='revealed', verbose_name='submission', to='contests.Submission', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem', models.OneToOneField(related_name='scores_reveal_config', verbose_name='problem', to='problems.Problem', on_delete=models.CASCADE)),
            ],
            options={
