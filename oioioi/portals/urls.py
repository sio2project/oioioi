...
noncontest_patterns = [
    ...
    url(r'^p/(?P<link_name>[^/]+)/(?P<portal_path>.*)$',
        views.global_portal_view, name='global_portal'),
    ...
    url(r'^portals_main_page/$', views.portals_main_page_view,
        name='portals_main_page'),
    url(r'^portals_main_page/(?P<view_type>[^/]+)/$',
        views.portals_main_page_view, name='portals_main_page_type')
]
