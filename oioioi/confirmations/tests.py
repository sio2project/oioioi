...
class TestEmailReceipt(TestCase, SubmitFileMixin):
    ...
    def test_sending_receipt(self):
        ...
        response = self.submit_file(contest, problem_instance, user="test_admin", kind="NORMAL")
        self._assertSubmitted(contest, response)
    ...
    def test_not_sending_receipt(self):
        ...
        response = self.submit_file(contest, problem_instance, user="test_admin", kind="IGNORED")
        self._assertSubmitted(contest, response)
        self.assertEqual(len(mail.outbox), 0)
