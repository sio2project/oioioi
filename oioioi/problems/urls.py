...
urlpatterns = [
    ...
    path("latest_submissions/", views.get_last_submissions, name="latest_submissions"),
    path(
...
noncontest_patterns = [path("problemset/", views.problemset_main_view, name="problemset_main")]
