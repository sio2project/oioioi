...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QueuedSubmit'
        db.create_table(u'submitsqueue_queuedsubmit', (
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contests.Submission'], primary_key=True)),
            ('state', self.gf('oioioi.base.fields.EnumField')(default='QUEUED', max_length=64)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('celery_task_id', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'submitsqueue', ['QueuedSubmit'])


    def backwards(self, orm):
        # Deleting model 'QueuedSubmit'
        db.delete_table(u'submitsqueue_queuedsubmit')
    ...
    models = {
        ...
        u'submitsqueue.queuedsubmit': {
            'Meta': {'object_name': 'QueuedSubmit'},
            'celery_task_id': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True', 'null': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'state': ('oioioi.base.fields.EnumField', [], {'default': "'QUEUED'", 'max_length': '64'}),
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contests.Submission']", 'primary_key': 'True'})
        }
    }

    complete_apps = ['submitsqueue']