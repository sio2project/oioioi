...
class TeamsConfig(models.Model):
    ...
    modify_begin_date = models.DateTimeField(verbose_name=_("team modification begin date"), blank=True, null=True)
    modify_end_date = models.DateTimeField(verbose_name=_("team modification end date"), blank=True, null=True)
