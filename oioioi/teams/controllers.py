    ...
    def can_modify_team(self, request):
        ...
        try:
            ...
            if not tconfig.enabled or did_submit:
                return False
            after_start = (tconfig.modify_begin_date is None) or request.timestamp >= tconfig.modify_begin_date
            before_end = (tconfig.modify_end_date is None) or request.timestamp <= tconfig.modify_end_date
        ...
        try:
            ...
            if not is_contest_admin(request):
                form.fields["user"] = UserSelectionField(
                    ...
                    help_text=_("You are in the team, so submission will be sent as the team."),
                )
