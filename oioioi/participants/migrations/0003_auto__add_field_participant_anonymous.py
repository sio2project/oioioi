...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.anonymous'
        db.add_column(u'participants_participant', 'anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.anonymous'
        db.delete_column(u'participants_participant', 'anonymous')
