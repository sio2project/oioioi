...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'participants_testregistration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('oioioi.participants.fields.OneToOneBothHandsCascadingParticipantField')(related_name=u'participants_testregistration', unique=True, to=orm['participants.Participant'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'participants', ['TestRegistration'])


    def backwards(self, orm):
        # Deleting model 'TestRegistration'
        db.delete_table(u'participants_testregistration')
    ...
    models = {
        ...
        u'participants.testregistration': {
            'Meta': {'object_name': 'TestRegistration'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'participant': ('oioioi.participants.fields.OneToOneBothHandsCascadingParticipantField', [], {'related_name': "u'participants_testregistration'", 'unique': 'True', 'to': u"orm['participants.Participant']"})
        }
    }
