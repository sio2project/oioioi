...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('participants_participant', (
            ...
            ('status', self.gf('oioioi.base.fields.EnumField')(default='ACTIVE', max_length=64)),
        ))
        db.send_create_signal('participants', ['Participant'])

        # Adding unique constraint on 'Participant', fields ['contest', 'user']
        db.create_unique('participants_participant', ['contest_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Participant', fields ['contest', 'user']
        db.delete_unique('participants_participant', ['contest_id', 'user_id'])
