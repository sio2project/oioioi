    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant', oioioi.participants.fields.OneToOneBothHandsCascadingParticipantField(related_name='participants_openregistration', to='participants.Participant')),
            ],
            options={
                'abstract': False,
            },
