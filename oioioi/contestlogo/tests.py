...
class TestProcessorsWithoutUploadedFiles(TestCase):
    ...
    def test_without_defaults(self):
        ...
        contest.controller_name = "oioioi.contestlogo.tests.ContestControllerWithoutDefaults"
        contest.save()
    ...
    def test_with_defaults(self):
        contest = Contest.objects.get()
        contest.controller_name = "oioioi.contestlogo.tests.ContestControllerWithDefaults"
        contest.save()
        response = self._render_menu()
