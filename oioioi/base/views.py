...
@account_menu_registry.register_decorator(_("Edit profile"), lambda request: reverse("edit_profile"), order=99)
...
def delete_account_view(request):
    ...
    if request.POST:
        ...
        if request.user.check_password(auth_password):
            ...
            request.user.save()
            return AuthLogoutView.as_view()(request, template_name="registration/delete_account_done.html")
        else:
