...
member_type_dependent_patterns = [
    ...
    path("registration/add_user/", views.add_user_to_contest, name="teachers_add_user_to_contest"),
    path("registration/get_appendable_users/", views.get_appendable_users_view, name="teachers_get_appendable_users"),
]
