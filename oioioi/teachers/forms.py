...
from oioioi.teachers.utils import validate_can_add_user_to_contest
...
class AddTeacherForm(forms.ModelForm):
    ...
    school = forms.CharField(
        label=_("School"),
        help_text=mark_safe(
            _("Please provide the full name. If the school is a part of a larger organization of schools, <br>enter the name of this organization.")
        ),
    )

    message = forms.CharField(
        label=_("Message"),
        help_text=_("Optional. If provided, this message will be sent to the managers."),
        required=False,
