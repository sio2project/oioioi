...
class PARegistration(RegistrationModel):
    ...
    job = models.CharField(max_length=7, choices=JOB_TYPES, verbose_name=_("job or school kind"))
    job_name = models.CharField(max_length=255, verbose_name=_("job or school name"))
    t_shirt_size = models.CharField(max_length=7, null=True, blank=True, choices=T_SHIRT_SIZES, verbose_name=_("t-shirt size"))
    newsletter = models.BooleanField(
        _("newsletter"),
        help_text=_("I want to receive the information about further editions of the contest."),
        default=False,
    )
    ...
    no_prizes = models.BooleanField(_("I don't want to provide my address (opt out of prizes)"), default=False)
...
class PAProblemInstanceData(models.Model):
    problem_instance = models.OneToOneField(ProblemInstance, primary_key=True, on_delete=models.CASCADE)
