...
@date_registry.register("start_date", name_generator=(lambda obj: _("Enable complaints")))
@date_registry.register("end_date", name_generator=(lambda obj: _("Disable complaints")))
class ComplaintsConfig(models.Model):
    contest = models.OneToOneField(Contest, related_name="complaints_config", on_delete=models.CASCADE)
