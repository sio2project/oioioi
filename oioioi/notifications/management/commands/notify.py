...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("-a", "--address", type=str, action="store", help="adds a link")
        parser.add_argument(
            "-d",
            "--details",
            type=str,
    ...
    def handle(self, *args, **options):
        ...
        if options["user"]:
            ...
            try:
                ...
                users = contest.controller.registration_controller().filter_participants(User.objects.all())
        ...
        for user in users:
            NotificationHandler.send_notification(user, "custom_notification", message, arguments)
