...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VoluntarySolutionPublication'
        db.create_table(u'publicsolutions_voluntarysolutionpublication', (
            ('submission', self.gf('django.db.models.fields.related.OneToOneField')(related_name='publication', unique=True, primary_key=True, to=orm['contests.Submission'])),
        ))
        db.send_create_signal(u'publicsolutions', ['VoluntarySolutionPublication'])


    def backwards(self, orm):
        # Deleting model 'VoluntarySolutionPublication'
        db.delete_table(u'publicsolutions_voluntarysolutionpublication')
    ...
    models = {
        ...
        u'publicsolutions.voluntarysolutionpublication': {
            'Meta': {'object_name': 'VoluntarySolutionPublication'},
            'submission': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'publication'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['contests.Submission']"})
        }
    }

    complete_apps = ['publicsolutions']
