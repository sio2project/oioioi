...
class Migration(DataMigration):
    ...
    models = {
        ...
        u'forum.post': {
            'Meta': {'ordering': "('add_date',)", 'object_name': 'Post', 'index_together': "(('thread', 'add_date'),)"},
        ...
        u'forum.thread': {
            'Meta': {'ordering': "('last_post__id',)", 'object_name': 'Thread'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['forum.Category']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'last_post_of'", 'null': 'True', 'to': u"orm['forum.Post']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }
