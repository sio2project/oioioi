...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'forum_thread', 'last_post',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_post_of', null=True, to=orm['forum.Post']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thread.last_post'
        db.delete_column(u'forum_thread', 'last_post_id')
