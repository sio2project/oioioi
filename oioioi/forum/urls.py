...
forum_patterns = [
    url(r'^$', views.forum_view, name='forum'),
    url(r'^lock/$', views.lock_forum_view, name='forum_lock'),
    url(r'^unlock/$', views.unlock_forum_view, name='forum_unlock'),
    url(r'^latest_posts/$', views.latest_posts_forum_view, name='forum_latest_posts'),
    url(r'^(?P<category_id>\d+)/$', views.category_view, name='forum_category'),
    url(
