...
class Migration(SchemaMigration):
    ...
    depends_on = (
            ("problems", "0004_auto__add_problempackage"),
    )

    def forwards(self, orm):
        # Adding field 'OriginalPackage.problem_package'
        db.add_column(u'sinolpack_originalpackage', 'problem_package',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['problems.ProblemPackage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OriginalPackage.problem_package'
        db.delete_column(u'sinolpack_originalpackage', 'problem_package_id')
