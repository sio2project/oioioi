...
class Migration(SchemaMigration):
    ...
    depends_on = (
            ("problems", "0005_move_package_files_from_sinolpack_origpack_to_problempackage"),
    )

    def forwards(self, orm):
        # Deleting field 'OriginalPackage.package_file'
        db.delete_column(u'sinolpack_originalpackage', 'package_file')


    def backwards(self, orm):
        # Adding field 'OriginalPackage.package_file'
        db.add_column(u'sinolpack_originalpackage', 'package_file',
                      self.gf('oioioi.filetracker.fields.FileField')(default='', max_length=100),
                      keep_default=False)
