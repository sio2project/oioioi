...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OriginalPackage'
        db.create_table('sinolpack_originalpackage', (
        ...
        db.send_create_signal('sinolpack', ['OriginalPackage'])


    def backwards(self, orm):
        # Deleting model 'OriginalPackage'
        db.delete_table('sinolpack_originalpackage')
