...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ZeusAsyncJob.kind'
        db.delete_column(u'zeus_zeusasyncjob', 'kind')

        # Adding field 'ZeusAsyncJob.resumed'
        db.add_column(u'zeus_zeusasyncjob', 'resumed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ZeusAsyncJob.kind'
        db.add_column(u'zeus_zeusasyncjob', 'kind',
                      self.gf('oioioi.base.fields.EnumField')(default='', max_length=64),
                      keep_default=False)

        # Deleting field 'ZeusAsyncJob.resumed'
        db.delete_column(u'zeus_zeusasyncjob', 'resumed')
    ...
    models = {
        ...
        u'zeus.zeusasyncjob': {
            ...
            'resumed': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'zeus.zeusfetchseq': {
