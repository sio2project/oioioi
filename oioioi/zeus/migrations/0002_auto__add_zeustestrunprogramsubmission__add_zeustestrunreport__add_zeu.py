...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ZeusTestRunProgramSubmission'
        db.create_table(u'zeus_zeustestrunprogramsubmission', (
            (u'testrunprogramsubmission_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['testrun.TestRunProgramSubmission'], unique=True, primary_key=True)),
            ('library_file', self.gf('oioioi.filetracker.fields.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'zeus', ['ZeusTestRunProgramSubmission'])

        # Adding model 'ZeusTestRunReport'
        db.create_table(u'zeus_zeustestrunreport', (
            (u'testrunreport_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['testrun.TestRunReport'], unique=True, primary_key=True)),
            ('full_out_size', self.gf('django.db.models.fields.IntegerField')()),
            ('full_out_handle', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'zeus', ['ZeusTestRunReport'])

        # Adding model 'ZeusAsyncJob'
        db.create_table(u'zeus_zeusasyncjob', (
            ('check_uid', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('kind', self.gf('oioioi.base.fields.EnumField')(max_length=64)),
            ('environ', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'zeus', ['ZeusAsyncJob'])


    def backwards(self, orm):
        # Deleting model 'ZeusTestRunProgramSubmission'
        db.delete_table(u'zeus_zeustestrunprogramsubmission')

        # Deleting model 'ZeusTestRunReport'
        db.delete_table(u'zeus_zeustestrunreport')

        # Deleting model 'ZeusAsyncJob'
        db.delete_table(u'zeus_zeusasyncjob')
    ...
    models = {
        ...
        u'zeus.zeustestrunprogramsubmission': {
            ...
            'library_file': ('oioioi.filetracker.fields.FileField', [], {'max_length': '100'}),
