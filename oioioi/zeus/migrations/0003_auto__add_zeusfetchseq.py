...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ZeusFetchSeq'
        db.create_table(u'zeus_zeusfetchseq', (
            ('zeus_id', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True)),
            ('next_seq', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'zeus', ['ZeusFetchSeq'])


    def backwards(self, orm):
        # Deleting model 'ZeusFetchSeq'
        db.delete_table(u'zeus_zeusfetchseq')
