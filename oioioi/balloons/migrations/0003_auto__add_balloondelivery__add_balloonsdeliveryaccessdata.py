...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BalloonDelivery'
        db.create_table(u'balloons_balloondelivery', (
            ...
            ('first_accepted_solution', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'balloons', ['BalloonDelivery'])

        # Adding unique constraint on 'BalloonDelivery', fields ['user', 'problem_instance']
        db.create_unique(u'balloons_balloondelivery', ['user_id', 'problem_instance_id'])

        # Adding model 'BalloonsDeliveryAccessData'
        db.create_table(u'balloons_balloonsdeliveryaccessdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'balloons', ['BalloonsDeliveryAccessData'])


    def backwards(self, orm):
        # Removing unique constraint on 'BalloonDelivery', fields ['user', 'problem_instance']
        db.delete_unique(u'balloons_balloondelivery', ['user_id', 'problem_instance_id'])

        # Deleting model 'BalloonDelivery'
        db.delete_table(u'balloons_balloondelivery')

        # Deleting model 'BalloonsDeliveryAccessData'
        db.delete_table(u'balloons_balloonsdeliveryaccessdata')
    ...
    models = {
        ...
        u'balloons.balloondelivery': {
            'Meta': {'ordering': "['id']", 'unique_together': "(('user', 'problem_instance'),)", 'object_name': 'BalloonDelivery'},
            'delivered': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'first_accepted_solution': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'problem_instance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contests.ProblemInstance']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'balloons.balloonsdeliveryaccessdata': {
            'Meta': {'object_name': 'BalloonsDeliveryAccessData'},
        ...
        u'balloons.balloonsdisplay': {
            'Meta': {'object_name': 'BalloonsDisplay'},
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contests.Contest']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_addr': ('django.db.models.fields.GenericIPAddressField', [], {'unique': 'True', 'max_length': '39'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
