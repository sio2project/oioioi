...
class ProblemBalloonsConfig(models.Model):
    ...
    def __str__(self):
        return str(self.problem_instance) + " (" + str(self.color) + ")"


class BalloonsDisplay(models.Model):
    """Represents mapping for balloons display."""

    ip_addr = models.GenericIPAddressField(unique=True, unpack_ipv4=True, verbose_name=_("IP address"))
...
class BalloonDelivery(models.Model):
    ...
    first_accepted_solution = models.BooleanField(default=False, verbose_name=_("first accepted solution"))
