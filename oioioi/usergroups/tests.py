...
class TestContestRegistrationWithUsergroups(TestCase):
    ...
    def test_creating_group_from_contest(self):
        ...
        url = reverse("teacher_usergroups_add_group", kwargs={"contest_id": contest.id}) + "?create_from_contest=True"
    ...
    def test_pupils_site(self):
        ...
        self.assertContains(response, "You have not added any group to this contest yet.")
        ...
        self.assertNotContains(response, "You have not added any group to this contest yet.")
