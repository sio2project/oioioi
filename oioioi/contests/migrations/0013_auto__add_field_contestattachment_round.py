...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContestAttachment.round'
        db.add_column(u'contests_contestattachment', 'round',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='r_attachments', null=True, to=orm['contests.Round']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContestAttachment.round'
        db.delete_column(u'contests_contestattachment', 'round_id')
