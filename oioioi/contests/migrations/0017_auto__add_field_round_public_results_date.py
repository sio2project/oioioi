...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Round.public_results_date'
        db.add_column(u'contests_round', 'public_results_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Round.public_results_date'
        db.delete_column(u'contests_round', 'public_results_date')
