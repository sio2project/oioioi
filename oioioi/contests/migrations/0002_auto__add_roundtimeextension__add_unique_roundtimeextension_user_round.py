...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RoundTimeExtension'
        db.create_table('contests_roundtimeextension', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('round', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contests.Round'])),
            ('extra_time', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('contests', ['RoundTimeExtension'])

        # Adding unique constraint on 'RoundTimeExtension', fields ['user', 'round']
        db.create_unique('contests_roundtimeextension', ['user_id', 'round_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RoundTimeExtension', fields ['user', 'round']
        db.delete_unique('contests_roundtimeextension', ['user_id', 'round_id'])

        # Deleting model 'RoundTimeExtension'
        db.delete_table('contests_roundtimeextension')
