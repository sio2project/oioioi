...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contest.contact_email'
        db.add_column(u'contests_contest', 'contact_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contest.contact_email'
        db.delete_column(u'contests_contest', 'contact_email')
