...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Submission', fields ['date']
        db.create_index('contests_submission', ['date'])


    def backwards(self, orm):
        # Removing index on 'Submission', fields ['date']
        db.delete_index('contests_submission', ['date'])
