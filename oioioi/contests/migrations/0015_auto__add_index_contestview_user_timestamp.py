...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ContestView', fields ['user', 'timestamp']
        db.create_index(u'contests_contestview', ['user_id', 'timestamp'])


    def backwards(self, orm):
        # Removing index on 'ContestView', fields ['user', 'timestamp']
        db.delete_index(u'contests_contestview', ['user_id', 'timestamp'])
