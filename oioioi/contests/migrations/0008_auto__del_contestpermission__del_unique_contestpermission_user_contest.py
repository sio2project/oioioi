...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SubmissionReport', fields ['submission', 'creation_date', 'id']
        db.create_unique('contests_submissionreport', ['submission_id', 'creation_date', 'id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SubmissionReport', fields ['submission', 'creation_date', 'id']
        db.delete_unique('contests_submissionreport', ['submission_id', 'creation_date', 'id'])
