...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContestView'
        db.create_table(u'contests_contestview', (
        ...
        db.send_create_signal(u'contests', ['ContestView'])

        # Adding unique constraint on 'ContestView', fields ['user', 'contest']
        db.create_unique(u'contests_contestview', ['user_id', 'contest_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContestView', fields ['user', 'contest']
        db.delete_unique(u'contests_contestview', ['user_id', 'contest_id'])

        # Deleting model 'ContestView'
        db.delete_table(u'contests_contestview')
    ...
    models = {
        ...
        u'contests.contestview': {
            'Meta': {'ordering': "('-timestamp',)", 'unique_together': "(('user', 'contest'),)", 'object_name': 'ContestView'},
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contests.Contest']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
