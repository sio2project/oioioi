...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProblemStatementConfig'
        db.create_table(u'contests_problemstatementconfig', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contest', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['contests.Contest'], unique=True)),
            ('visible', self.gf('oioioi.base.fields.EnumField')(default='AUTO', max_length=64)),
        ))
        db.send_create_signal(u'contests', ['ProblemStatementConfig'])


    def backwards(self, orm):
        # Deleting model 'ProblemStatementConfig'
        db.delete_table(u'contests_problemstatementconfig')
    ...
    models = {
        ...
        u'contests.contestlink': {
            'Meta': {'object_name': 'ContestLink'},
        ...
        u'contests.problemstatementconfig': {
            'Meta': {'object_name': 'ProblemStatementConfig'},
            'contest': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['contests.Contest']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'visible': ('oioioi.base.fields.EnumField', [], {'default': "'AUTO'", 'max_length': '64'})
        },
        u'contests.round': {
