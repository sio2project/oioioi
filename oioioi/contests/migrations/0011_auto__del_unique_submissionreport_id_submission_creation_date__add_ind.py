...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SubmissionReport', fields ['id', 'submission', 'creation_date']
        db.delete_unique(u'contests_submissionreport', ['id', 'submission_id', 'creation_date'])

        # Adding index on 'SubmissionReport', fields ['submission', 'creation_date']
        db.create_index(u'contests_submissionreport', ['submission_id', 'creation_date'])


    def backwards(self, orm):
        # Removing index on 'SubmissionReport', fields ['submission', 'creation_date']
        db.delete_index(u'contests_submissionreport', ['submission_id', 'creation_date'])

        # Adding unique constraint on 'SubmissionReport', fields ['id', 'submission', 'creation_date']
        db.create_unique(u'contests_submissionreport', ['id', 'submission_id', 'creation_date'])
    ...
    models = {
        ...
        u'contests.contestattachment': {
            ...
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attachments'", 'to': u"orm['contests.Contest']"}),
