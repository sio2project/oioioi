...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Contest', fields ['creation_date']
        db.create_index(u'contests_contest', ['creation_date'])


    def backwards(self, orm):
        # Removing index on 'Contest', fields ['creation_date']
        db.delete_index(u'contests_contest', ['creation_date'])
