...
contest_patterns = [
    path("render_contest_id/", tests.render_contest_id_view, name="render_contest_id"),
]
...
urlpatterns = make_patterns(neutral_patterns, contest_patterns, noncontest_patterns, urls.urlpatterns)
