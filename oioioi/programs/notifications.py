...
def notification_function_initial_results(arguments):
    ...
    if pi.contest:
        ...
        url = reverse("problem_site", kwargs={"site_key": pi.problem.problemsite.url_key}) + "?key=submissions"
    else:
        url = ""
    ...
    NotificationHandler.send_notification(arguments.user, "initial_results", message, message_arguments)


NotificationHandler.register_notification("initial_results", notification_function_initial_results)
...
def notification_function_submission_judged(arguments):
    ...
    message = pi.controller.get_notification_message_submission_judged(arguments.submission)
    ...
    NotificationHandler.send_notification(arguments.user, "submission_judged", message, message_arguments)


NotificationHandler.register_notification("submission_judged", notification_function_submission_judged)
