...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Test', fields ['problem', 'name']
        db.create_unique(u'programs_test', ['problem_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Test', fields ['problem', 'name']
        db.delete_unique(u'programs_test', ['problem_id', 'name'])
