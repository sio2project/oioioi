...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('contests', '0018_auto__add_field_scorereport_max_score'),
    )

    def forwards(self, orm):
        # Adding field 'GroupReport.max_score'
        db.add_column(u'programs_groupreport', 'max_score',
                      self.gf('oioioi.contests.fields.ScoreField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupReport.max_score'
        db.delete_column(u'programs_groupreport', 'max_score')
