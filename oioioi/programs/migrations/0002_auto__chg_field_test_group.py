...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Test.group'
        db.alter_column('programs_test', 'group', self.gf('django.db.models.fields.CharField')(default=0, max_length=30))

    def backwards(self, orm):

        # Changing field 'Test.group'
        db.alter_column('programs_test', 'group', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
