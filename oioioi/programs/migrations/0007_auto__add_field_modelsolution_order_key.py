...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelSolution.order_key'
        db.add_column(u'programs_modelsolution', 'order_key',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelSolution.order_key'
        db.delete_column(u'programs_modelsolution', 'order_key')
