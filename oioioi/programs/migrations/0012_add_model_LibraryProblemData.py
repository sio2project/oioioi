...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LibraryProblemData'
        db.create_table(u'programs_libraryproblemdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('problem', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['problems.Problem'], unique=True)),
            ('libname', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'programs', ['LibraryProblemData'])


    def backwards(self, orm):
        # Deleting model 'LibraryProblemData'
        db.delete_table(u'programs_libraryproblemdata')
