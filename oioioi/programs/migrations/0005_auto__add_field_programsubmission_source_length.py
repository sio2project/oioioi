...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProgramSubmission.source_length'
        db.add_column(u'programs_programsubmission', 'source_length',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProgramSubmission.source_length'
        db.delete_column(u'programs_programsubmission', 'source_length')
