...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.is_active'
        db.add_column(u'oi_school', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'School.is_approved'
        db.add_column(u'oi_school', 'is_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding unique constraint on 'School', fields ['postal_code', 'name']
        db.create_unique(u'oi_school', ['postal_code', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'School', fields ['postal_code', 'name']
        db.delete_unique(u'oi_school', ['postal_code', 'name'])

        # Deleting field 'School.is_active'
        db.delete_column(u'oi_school', 'is_active')

        # Deleting field 'School.is_approved'
        db.delete_column(u'oi_school', 'is_approved')
    ...
    models = {
        ...
        u'oi.school': {
            'Meta': {'unique_together': "(('name', 'postal_code'),)", 'object_name': 'School'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
