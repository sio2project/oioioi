...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OIRegistration.school'
        db.alter_column(u'oi_oiregistration', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oi.School'], null=True))

    def backwards(self, orm):

        # Changing field 'OIRegistration.school'
        db.alter_column(u'oi_oiregistration', 'school_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oi.School'], null=True, on_delete=models.SET_NULL))
    ...
    models = {
        ...
        u'oi.oiregistration': {
            ...
            'school': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['oi.School']", 'null': 'True'}),
        ...
        u'oi.school': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'postal_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'db_index': 'True'}),
