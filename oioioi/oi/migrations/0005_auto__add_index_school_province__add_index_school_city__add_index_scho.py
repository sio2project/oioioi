...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'School', fields ['postal_code']
        db.create_index(u'oi_school', ['postal_code'])


    def backwards(self, orm):
        # Removing index on 'School', fields ['postal_code']
        db.delete_index(u'oi_school', ['postal_code'])
